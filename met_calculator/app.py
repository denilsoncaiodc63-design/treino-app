...
def clean_text_for_match(text: str) -> str:
    ...
    for noise in ("com halteres", "com barra", "na maquina", "no cabo", "na polia", "por lado"):
    ...
    alias_map = {
        ...
        "rosca scott": "rosca direta com barra",
...
peso = st.number_input("Seu peso (kg):", min_value=30, max_value=200, value=74)
